...
import {InstantiateMsg, ExecuteMsg, Addr, Uint128, Metadata, DenomUnit, QueryMsg, DenomsByCreatorResponse, FullDenomResponse, MetadataResponse, ParamsResponse, Params, Coin} from "./Tokenfactory.types";
export interface TokenfactoryReadOnlyInterface {
  ...
  getParams: () => Promise<ParamsResponse>;
}
export class TokenfactoryQueryClient implements TokenfactoryReadOnlyInterface {
  ...
  getParams = async (): Promise<ParamsResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      get_params: {}
    });
  };
